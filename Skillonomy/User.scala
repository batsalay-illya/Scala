case class User(firstName: String, lastName: String, age: Int, country: String, city: String, street: String) extends Address(country, city, street), Wallet {
  ...
  def Print(): Unit = {
    println(s"First name: ${if(_firstName == "") '-' else _firstName}, Last name: ${if(_lastName == "") '-' else _lastName}, Age: ${_age}, Address: [${GetFullAddress()}], Token balance: ${GetTokenBalance}, Currency balance: ${GetCurrencyBalance}")
  }
}
